...
def submit_lyric(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                "Your lyric has been submitted and is awaiting approval.",
            )
...
def profile(request):
    ...
    return render(
        request, "lyrics/profile.html", {"form": form, "page_obj": page_obj}
    )
...
def edit_lyric(request, slug):
    ...
    return render(
        request, "lyrics/edit_lyric.html", {"form": form, "lyric": lyric}
    )
...
def delete_lyric(request, slug):
    ...
    if request.method == "POST":
        ...
        return redirect("profile")
    return render(
        request, "lyrics/confirm_delete_lyric.html", {"lyric": lyric})
